        ...
        <div className="create-form" style={{ marginBottom: '20px' }}>
          ...
          <div className="form-group">
            ...
            <select
              ...
              className="action-select"
            >
              <option value={1}>🎯 Уровень 1 - Главное меню (отображается в меню бота ☰)</option>
              <option value={2}>📂 Уровень 2 - Подменю (доступно через кнопки уровня 1)</option>
              <option value={3}>📁 Уровень 3 - Вложенное меню (доступно через уровень 2)</option>
            </select>
            <div style={{ fontSize: '12px', color: '#8d969e', marginTop: '5px', lineHeight: '1.5' }}>
              <strong>Как работают уровни:</strong><br/>
              • <strong>Уровень 1</strong> - кнопки видны в главном меню бота (☰)<br/>
              • <strong>Уровень 2+</strong> - кнопки появляются только когда пользователь нажимает на кнопку с действием "Отправить блок"<br/>
              <br/>
              <strong>Пример структуры:</strong><br/>
              📋 Главное меню (уровень 1) → действие "блок" → список товаров (уровень 2) → действие "блок" → детали товара (уровень 3)
            </div>
          </div>
